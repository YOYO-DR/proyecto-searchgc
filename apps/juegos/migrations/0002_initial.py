...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='rams',
            name='velocidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='juegos.ramsvelocidades'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='graficas',
            name='gb',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='juegos.graficasgb'),
        ),
        migrations.AddField(
            model_name='graficas',
            name='velocidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='juegos.graficasvelocidades'),
        ),
        migrations.AddField(
